...
bool j1Fonts::Start()
{
	title = Load("fonts/kenvector_future.ttf", 20);
	credits = Load("fonts/arial.ttf", 9);
	title_settings = Load("fonts/kenvector_future.ttf", 15);
	title_config = Load("fonts/kenvector_future.ttf", 15);
