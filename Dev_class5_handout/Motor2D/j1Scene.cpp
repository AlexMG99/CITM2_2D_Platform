...
bool j1Scene::Update(float dt)
{
	...
	if (App->player->position.x > (App->win->GetWidth() / App->win->GetScale()) / 4 && App->player->position.x < App->map->data.width * App->map->data.tile_width - App->render->camera.w / App->win->GetScale() + App->player->player_coll->rect.w*App->win->GetScale())
	{
